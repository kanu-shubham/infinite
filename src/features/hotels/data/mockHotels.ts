...
function generateHotels(count = 48): Hotel[] {
  ...
  return Array.from({ length: count }, (_, i): Hotel => {
    ...
    return {
      ...
      description: `Experience exceptional comfort and service at ${name}. Located in a prime area with easy access to local attractions.`,
    };
  });
}

export const mockHotels: Hotel[] = generateHotels();
